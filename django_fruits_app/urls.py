...
urlpatterns = [
    ...
    path('administrator/edit/profile/<int:admin_id>/', views.admin_edit_profile, name='admin_edit_profile'),
    path('administrator/delete/profile/<int:admin_id>/', views.admin_delete_profile, name='admin_delete_profile'),
    path('administrator/change/password/<int:admin_id>', views.admin_chpwd_profile, name='admin_chpwd_profile'),
